module Route = {
  ...
  let make = (~exact: bool, ~path: string, ~component: 'a => ReasonReact.reactElement, children) =>
...
external withRouter : ('a => ReasonReact.reactElement, 'a) => ReasonReact.reactElement =
  "";
